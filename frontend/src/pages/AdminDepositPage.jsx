    ...
    <div className="p-2 sm:p-6 w-full text-gray-900 dark:text-gray-100">
      ...
      <div className="flex flex-wrap gap-2 items-center mb-3 sm:mb-4">
        ...
        <div className="flex items-center gap-1 text-xs sm:text-sm">
          <input type="checkbox" checked={enabled.username}
        ...
        {/* 상태 */}
        <div className="flex items-center gap-1 text-xs sm:text-sm">
          <input type="checkbox" checked={enabled.status}
        ...
        {/* 날짜 */}
        <div className="flex items-center gap-1 text-xs sm:text-sm">
          <input type="checkbox" checked={enabled.date}
        ...
        <div className="flex gap-2 mt-2 sm:mt-0 w-full sm:w-auto">
          ...
          <button onClick={handleComplete} disabled={!selected.length}
            className="bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-1 rounded text-xs sm:text-sm
                       disabled:opacity-50">
            완료 처리
          </button>
        </div>
  ...
  {loading ? (
    ...
    <table className="min-w-[800px] w-full border-collapse text-xs sm:text-sm
      ...
      <thead className="bg-gray-100 dark:bg-gray-800">
        <tr>
          <th className="border px-2 py-1"></th> {/* 체크박스 */}
            ...
            <tr key={r.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/60 text-center">
              ...
              <td className="border px-2 py-1">
                <button onClick={() => handleDelete(r.id)}>
                  <Trash2 size={16} className="text-red-500 hover:text-red-600 dark:text-red-400 dark:hover:text-red-300" />
                </button>
              </td>
              {/* 신청금액 */}
