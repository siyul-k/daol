              ...
              <div key={idx}>
                {item.children ? (
                  <div className="relative group">
                    <Button variant="ghost" className="text-base font-bold inline-flex items-center gap-1">
                      {item.icon} {item.label}
                    </Button>
                    <div className="absolute hidden group-hover:block bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg mt-2">
                  ...
                  <Button
                    ...
                    className={`text-base font-bold inline-flex items-center gap-1 ${
                      location.pathname === item.path ? "text-blue-600 dark:text-cyan-300" : ""
                    }`}
